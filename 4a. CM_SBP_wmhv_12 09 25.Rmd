...
ggsave("./results/lp_exp_wmhv_sbp.jpeg",
       dpi = 400,
       plot = lp_exp_wmhv_sbp)
...
ggsave("./results/lp_med_wmhv_sbp.jpeg",
       dpi = 400,
       plot = lp_med_wmhv_sbp)
...
For the CDE, we model logWMHV_2 as a function of the race/ethnicity, hypertension, and their interaction, weighted by the SW as calculated by the cumulative product of both the exposure, mediator, and selection weights. The estimate for the Black and Hispanic reflect the CDE of those exposures, holding HTN =0, in other words, what is the effect of race/ethnicity if we control hypertension.  
